const RoomQualities = ({ bath, rooms, area }) => {
  return (
    <ul className="w-full flex items-center list-none mb-[10px] lg:mb-[30px]">
      <li className="flex items-center lg:me-6 me-4">
        <svg
          ...
          strokeWidth="0"
          viewBox="0 0 32 32"
          className="lg:text-sm text-2xl md:text-sm me-2 text-customGreen"
          height="1em"
          width="1em"
        ...
        <span className="md:text-lg dark: dark:text-slate-400">{area} м²</span>
      </li>
      <li className="flex items-center lg:me-6 me-4">
        <svg
          stroke="currentColor"
        ...
        <span className="md:text-sm lg:text-xl dark: dark:text-slate-400">
          {rooms}
        </span>
      </li>
      <li className="flex items-center lg:me-6 me-4">
