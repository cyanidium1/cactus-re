    ...
    <ul className="py-6 flex items-center list-none">
      <li className="flex items-center lg:me-6 me-4">
        <svg
          ...
          strokeWidth="0"
          viewBox="0 0 32 32"
          className="lg:text-3xl text-2xl me-2 text-customGreen"
          height="1em"
          width="1em"
        ...
        <span className="lg:text-xl dark: dark:text-slate-400">{area} м²</span>
      </li>
      <li className="flex items-center lg:me-6 me-4">
        <svg
          stroke="currentColor"
        ...
        <span className="lg:text-xl dark: dark:text-slate-400">{rooms}</span>
      </li>
      <li className="flex items-center lg:me-6 me-4">
        <svg
          stroke="currentColor"
        ...
        <span className="lg:text-xl dark dark:text-slate-400">{bath}</span>
      </li>
    </ul>
  );
};
